  ...
  return (
    <div className="overflow-auto p-8">
      <ReactMarkdown
        ...
        components={{
          h1: ({ node, ...props }) => <h1 className="mb-4 text-3xl font-bold text-gray-800 dark:text-gray-200" {...props} />,
          h2: ({ node, ...props }) => <h2 className="mt-5 mb-3 text-2xl font-bold text-gray-800 dark:text-gray-200" {...props} />,
          h3: ({ node, ...props }) => <h3 className="mt-4 mb-2 text-xl font-semibold text-gray-800 dark:text-gray-200" {...props} />,
          ...
          blockquote: ({ node, ...props }) => <blockquote className="my-4 border-l-4 border-gray-300 pl-4 italic" {...props} />,
          code: ({ node, ...props }) => <code className="font-mono text-sm" {...props} />,
          pre: ({ node, ...props }) => <pre className="my-4 overflow-x-auto rounded bg-gray-50 p-3 text-xs" {...props} />,
        }}
      >
        {lesson.content}
      </ReactMarkdown>
