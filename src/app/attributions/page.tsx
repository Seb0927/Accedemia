  ...
  return (
    <>
      <div className="flex size-full items-center justify-center p-4">
        <Card className="max-w-2xl max-h-10/12 overflow-auto bg-base-100 p-8">
          ...
          <ul className="mb-6 list-disc pl-5 space-y-1">
            <li>
              <a href="https://github.com/vercel/next.js" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>Next.js (v15.5.2)</strong>
              </a> - Framework de React para aplicaciones web
            </li>
            <li>
              <a href="https://github.com/facebook/react" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>React (v19.1.0)</strong>
              </a> - Biblioteca para construir interfaces de usuario
            </li>
            <li>
              <a href="https://github.com/pmndrs/zustand" target="_blank" rel="noopener noreferrer" className="link link-hover">
          ...
          <ul className="mb-6 list-disc pl-5 space-y-1">
            <li>
              <a href="https://github.com/microsoft/monaco-editor" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>Monaco Editor (v0.52.2)</strong>
              </a> - Editor de código usado en VS Code
            </li>
            <li>
              <a href="https://github.com/suren-atoyan/monaco-react" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>@monaco-editor/react (v4.7.0)</strong>
              </a> - Integración de Monaco Editor para React
            </li>
            <li>
              <a href="https://github.com/shikijs/shiki" target="_blank" rel="noopener noreferrer" className="link link-hover">
          ...
          <ul className="mb-6 list-disc pl-5 space-y-1">
            <li>
              <a href="https://github.com/stackblitz/webcontainer-core" target="_blank" rel="noopener noreferrer" className="link link-hover">
          ...
          <ul className="mb-6 list-disc pl-5 space-y-1">
            <li>
              <a href="https://github.com/googleapis/js-genai" target="_blank" rel="noopener noreferrer" className="link link-hover">
          ...
          <ul className="mb-6 list-disc pl-5 space-y-1">
            <li>
              <a href="https://github.com/remarkjs/react-markdown" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>React Markdown (v10.1.0)</strong>
              </a> - Renderizado de Markdown en React
            </li>
            <li>
              <a href="https://github.com/remarkjs/remark-gfm" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>remark-gfm (v4.0.1)</strong>
              </a> - Soporte para GitHub Flavored Markdown
            </li>
            <li>
              <a href="https://github.com/rehypejs/rehype-highlight" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>rehype-highlight (v7.0.2)</strong>
              </a> - Resaltado de código en Markdown
            </li>
            <li>
              <a href="https://github.com/rehypejs/rehype-raw" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>rehype-raw (v7.0.0)</strong>
              </a> - Procesamiento de HTML en Markdown
            </li>
            <li>
              <a href="https://github.com/lucide-icons/lucide" target="_blank" rel="noopener noreferrer" className="link link-hover">
          ...
          <ul className="mb-6 list-disc pl-5 space-y-1">
            <li>
              <a href="https://github.com/tailwindlabs/tailwindcss" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>Tailwind CSS (v4)</strong>
              </a> - Framework CSS utilitario
            </li>
            <li>
              <a href="https://github.com/saadeghi/daisyui" target="_blank" rel="noopener noreferrer" className="link link-hover">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <a href="https://github.com/microsoft/TypeScript" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>TypeScript (v5)</strong>
              </a> - Superset tipado de JavaScript
            </li>
            <li>
              <a href="https://github.com/eslint/eslint" target="_blank" rel="noopener noreferrer" className="link link-hover">
                <strong>ESLint (v9)</strong>
              </a> - Analizador de código estático
            </li>
            <li>
              <a href="https://github.com/TypeStrong/ts-node" target="_blank" rel="noopener noreferrer" className="link link-hover">
